...
// Por qué no funciona este método getMovie? Me da el siguiente error de compilación:
// Failed to compile.
// movies-info.service.ts (112,22): Property 'id' does not exist on type 'Object'.
  getMovie(id) {
    let foundMovie = this.movies.findIndex((element) => {
      return element.id === id;
    });
    return this.movies[foundMovie];
  }
